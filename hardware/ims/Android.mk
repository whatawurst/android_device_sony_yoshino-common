...
include $(CLEAR_VARS)
IMS_LIBQDMETADATA_SYMLINK := $(TARGET_OUT_SYSTEM_EXT)/lib64/libqdMetaData.so
$(IMS_LIBQDMETADATA_SYMLINK): $(LOCAL_INSTALLED_MODULE)
	@echo "Create ims libqdMetaData link: $@"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /system/lib64/libqdMetaData.system.so $@
